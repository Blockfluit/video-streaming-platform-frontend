...
<template>
    <div class="container">
        <div class="container-add-media">
            <form @submit.prevent="editStore.updateMedia(
                currentMediaId,
                thumbnail,
                type,
                genres,
                ...
                <div style="margin: 20px 0px'; display: flex; align-items: center; flex-direction: column">
                    ...
                    <ul class="video-order">
                        <div v-for="(video, index) in videosOrder"
                            ...
                            <input @change="e => videosOrder[index].index = e.target.valueAsNumber"
                                   type="number"
                                   :value="video.index"
